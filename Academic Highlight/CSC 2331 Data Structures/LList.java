    ...
    */  
    ...
    public int getFirstPosition(T anObject) {
		...
		while (position != null) {
			...
			else if (!anObject.equals(position.data)) {
    ...
    public boolean remove(T aValue){
    	...
    	while(!aValue.equals(currentNode.data) && currentNode != null){
    		
    		currentNode = currentNode.next;
    		
    		if(aValue.equals(currentNode.getData())){
    ...
    public static void main(String args[]){
    	...
    	LList<Integer> alist = new LList<Integer>();
...
/*    	for(int i = 0; i < a.length; i++){
    	...
    	// Test the getFirstPosition method.
    	 System.out.println("Position of number '3': " + alist.getFirstPosition(3));
    	...
    	// Test the getFirstPosition after the cycle method.
    	 System.out.println("Position after cycle method: " + alist.getFirstPosition(3));
    	System.out.println();
